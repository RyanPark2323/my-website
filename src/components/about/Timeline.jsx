...
const Timeline = () => {
  ...
  return (
    <section className="mb-12 p-8 bg-white rounded-lg shadow-lg">
      ...
      <div className="relative h-96 overflow-hidden" ref={timelineRef}>
        ...
        <div 
          ...
          style={{
            transform: `translateX(-${currentTimelineIndex * 300 - 100}px)`
          }}
        >
          {timelineData.map((item, index) => (
            <div key={index} className="relative min-w-[250px] mx-12 pt-8 text-center z-20">
              ...
              <div className={`bg-white rounded-lg p-5 mt-8 shadow-lg transition-all duration-300 min-h-[150px] ${
                index === currentTimelineIndex ? 'transform translate-y-0 opacity-100' : 'transform translate-y-5 opacity-0'
              }`}>
      ...
      <div className="text-center mt-5">
        <button 
          ...
          onClick={() => navigateToItem(currentTimelineIndex - 1)}
